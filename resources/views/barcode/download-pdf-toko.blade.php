...
<body>
    @php
    $toko   = \App\Models\Toko::wherePin(session('toko'))->firstOrFail();
    $user   = \App\Models\User::whereId($toko->user_id)->firstOrFail();   
    @endphp
    ...
    <table width="100%">
        <tr>
            <td align="left" style="width: 40%;">
                <h3>Pondok Pesantren {{ $user->pondoks->nama }}</h3>
                <p>{{ $user->pondoks->nama }}</p>
            </td>
