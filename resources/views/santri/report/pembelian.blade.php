    ...
    <table class="w-full whitespace-no-wrap">
        <thead>
            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                <th class="px-2 py-3">Toko</th>
                <th class="px-2 py-3">Rp / Pembelian</th>
            </tr>
        </thead>
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                <td class="px-2 py-3">
                    <span class="flex items-center text-sm">
                        ...
                        <div>
                            <p class="font-semibold">{{ $item->toko->nama }}</p>
                ...
                <td class="px-2 py-3 text-xs">
                    <div class="w-max py-1 font-semibold leading-tight text-red-500 rounded-full dark:bg-green-700 dark:text-green-100">
